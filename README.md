...
Internal users should copy the ELF3 MuJoCo XML and mesh files into:
...
Use the existing `gvhmr` conda environment:
...
This repository includes and modifies code from the upstream MIT-licensed GMR
project. The original upstream README continues below for reference.
